    ...
    <div v-if="agentDetail" class="agent-detail-content">
      ...
      <a-card class="mb-4">
        ...
        <div class="info-grid">
          ...
          <div class="info-item" v-if="agentDetail.host.environment">
            <span class="label">环境：</span>
            <span class="value">
              <a-tag color="green">{{ agentDetail.host.environment_display }}</a-tag>
            </span>
          </div>
          <div class="info-item" v-if="agentDetail.business_system_name || agentDetail.host.business_system">
            <span class="label">业务系统：</span>
            <span class="value">{{ agentDetail.business_system_name || agentDetail.host.business_system }}</span>
          </div>
